...
AActor* FZombieInventoryHelperMaasLiam::GetBestItem(UStudentPerceptorMaasLiam* Perceptor, AActor* Owner)
{
...
int32 FZombieInventoryHelperMaasLiam::GetItemPriority(AActor* ItemActor)
{
...
bool FZombieInventoryHelperMaasLiam::TryPickupItem(AActor* Owner, UActorComponent* InventoryComponent, UStudentPerceptorMaasLiam* Perceptor, AActor* ItemActor)
{
...
bool FZombieInventoryHelperMaasLiam::TryGrabItemInSlot(UActorComponent* InventoryComponent, int32 SlotIndex, AActor* ItemActor)
{
...
bool FZombieInventoryHelperMaasLiam::TryUseItemInSlot(UActorComponent* InventoryComponent, int32 SlotIndex)
{
	if (!InventoryComponent) return false;
...
bool FZombieInventoryHelperMaasLiam::TryRemoveItemInSlot(UActorComponent* InventoryComponent, int32 SlotIndex)
{
	if (!InventoryComponent) return false;
...
bool FZombieInventoryHelperMaasLiam::DoesInventorySlotContainItemType(UActorComponent* InventoryComponent, int32 SlotIndex, const FString& ItemType)
{
	if (!InventoryComponent) return false;
...
bool FZombieInventoryHelperMaasLiam::HasInventoryItemType(UActorComponent* InventoryComponent, const FString& ItemType)
{
	const int32 Capacity = GetInventoryCapacity(InventoryComponent);
...
bool FZombieInventoryHelperMaasLiam::IsInventoryFull(UActorComponent* InventoryComponent)
{
...
float FZombieInventoryHelperMaasLiam::GetPickupRange(UActorComponent* InventoryComponent)
{
...
int32 FZombieInventoryHelperMaasLiam::GetInventoryCapacity(UActorComponent* InventoryComponent)
{
...
int32 FZombieInventoryHelperMaasLiam::GetInventorySlotItemValue(UActorComponent* InventoryComponent, int32 SlotIndex)
{
...
int32 FZombieInventoryHelperMaasLiam::GetLowestInventoryPrioritySlot(UActorComponent* InventoryComponent)
{
...
bool FZombieInventoryHelperMaasLiam::TryReplaceInventoryItem(UActorComponent* InventoryComponent, UStudentPerceptorMaasLiam* Perceptor, AActor* NewItem)
{
...
bool FZombieInventoryHelperMaasLiam::CanReplaceInventoryItem(UActorComponent* InventoryComponent, AActor* NewItem)
{
	if (!InventoryComponent || !NewItem) return false;
...
bool FZombieInventoryHelperMaasLiam::HasUsableWeapon(UActorComponent* InventoryComponent)
{
