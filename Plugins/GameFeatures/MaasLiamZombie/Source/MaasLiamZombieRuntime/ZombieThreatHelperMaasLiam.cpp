...
AActor* FZombieThreatHelperMaasLiam::GetClosestZombie(UStudentPerceptorMaasLiam* Perceptor, AActor* Owner)
{
...
AActor* FZombieThreatHelperMaasLiam::GetClosestPurgeZone(UStudentPerceptorMaasLiam* Perceptor, AActor* Owner)
{
	if (!Perceptor || !Owner) return nullptr;
...
FVector FZombieThreatHelperMaasLiam::GetFleeLocation(UStudentPerceptorMaasLiam* Perceptor, AActor* Owner, float FleeDistance)
{
	if (!Owner)
	{
...
FVector FZombieThreatHelperMaasLiam::GetPurgeAvoidanceLocation(AActor* Owner, AActor* PurgeZone, float PurgeFleeDistance)
{
	if (!Owner || !PurgeZone)
	{
...
float FZombieThreatHelperMaasLiam::ScoreFleeLocation(UStudentPerceptorMaasLiam* Perceptor, const FVector& Location)
{
