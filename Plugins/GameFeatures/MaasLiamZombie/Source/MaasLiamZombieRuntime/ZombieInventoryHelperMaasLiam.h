...
class FZombieInventoryHelperMaasLiam
{
public:
	static AActor* GetBestItem(UStudentPerceptorMaasLiam* Perceptor, AActor* Owner);
	static int32 GetItemPriority(AActor* ItemActor);

	static bool TryPickupItem(AActor* Owner, UActorComponent* InventoryComponent, UStudentPerceptorMaasLiam* Perceptor, AActor* ItemActor);
	...
	static bool TryReplaceInventoryItem(UActorComponent* InventoryComponent, UStudentPerceptorMaasLiam* Perceptor, AActor* NewItem);
