...
class FZombieItemMemoryHelperMaasLiam
{
public:
	static void UpdateItemMemory(TArray<FRememberedItem>& RememberedItems, UStudentPerceptorMaasLiam* Perceptor, float DeltaTime, float MaxMemoryAge);
